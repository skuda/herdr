...
A new profile is unrestricted until you set availability. Open clients can connect in that window. Restrict it before sharing a catalog if other local sessions should not see it.
